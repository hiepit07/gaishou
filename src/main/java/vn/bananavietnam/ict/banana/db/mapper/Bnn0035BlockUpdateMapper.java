...
public interface Bnn0035BlockUpdateMapper {

	List<Bnn0035AreaExtendObject> getAreaAndKindDataFromMaster(Map<String, Object> params);

	List<Bnn0035AreaExtendObject> getAreaAndKindDataFromAffiliation(Map<String, Object> params);
	...
	int updateProductDate(Map<String, Object> params);
	...
	List<IvbTProductKey> getProductData(Map<String, Object> params);	
}
