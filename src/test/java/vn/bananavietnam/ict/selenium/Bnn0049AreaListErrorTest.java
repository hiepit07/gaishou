...
public class Bnn0049AreaListErrorTest {
	...
	private final String IE_VN_IMG_PATH = "selenium_test_images/0049/Error/IE/vn/";
	private final String IE_JP_IMG_PATH = "selenium_test_images/0049/Error/IE/jp/";
	private final String IE_EN_IMG_PATH = "selenium_test_images/0049/Error/IE/en/";
	private final String FF_VN_IMG_PATH = "selenium_test_images/0049/Error/Firefox/vn/";
	private final String FF_JP_IMG_PATH = "selenium_test_images/0049/Error/Firefox/jp/";
	private final String FF_EN_IMG_PATH = "selenium_test_images/0049/Error/Firefox/en/";
	private final String CHR_VN_IMG_PATH = "selenium_test_images/0049/Error/Chrome/vn/";
	private final String CHR_JP_IMG_PATH = "selenium_test_images/0049/Error/Chrome/jp/";
	private final String CHR_EN_IMG_PATH = "selenium_test_images/0049/Error/Chrome/en/";
	private final String EDGE_VN_IMG_PATH = "selenium_test_images/0049/Error/Edge/vn/";
	private final String EDGE_JP_IMG_PATH = "selenium_test_images/0049/Error/Edge/jp/";
	private final String EDGE_EN_IMG_PATH = "selenium_test_images/0049/Error/Edge/en/";
	...
	@Test
	public void testBnn0049AreaListSeleniumError() throws Exception {
		...
		for (int i = 0; i < testModeArray.length; i++) {
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
 			// store log file name
 			logFileNameArray.add(imagePath + "0049_3_1_1_1.log");
			SeleniumCommon.sessionTimeOut();
			driver.findElement(By.id("A001")).click();
			capture(imagePath + "0049_3_1_1_1");
			driver.get(baseUrl + pageLanguage);
  			driver.switchTo().frame(driver.findElement(By.id("wrapperFrame")));
 		    driver.findElement(By.id("j_username")).clear();
 		    driver.findElement(By.id("j_username")).sendKeys("U0000000002");
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
 			// store log file name
 			logFileNameArray.add(imagePath + "0049_3_2_1_1.log");
 			driver.findElement(By.id("A001")).click();
	  		capture(imagePath + "0049_3_2_1_1");
	  		driver.findElement(By.name("/ict/login")).click();
			...
			SeleniumCommon.disableDBServerConnection("BANANA_DB_HUNG_SELENIUM", "Hung");
	  		checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
 			// store log file name
 			logFileNameArray.add(imagePath + "0049_3_3_1_1.log");
 			driver.findElement(By.id("A001")).click();
	  		capture(imagePath + "0049_3_3_1_1");
	  		driver.findElement(By.name("/ict/login")).click();
 			SeleniumCommon.enableDBServerConnection("BANANA_DB_HUNG_SELENIUM", "Hung");
