...
public class Bnn0013SearchProcessSeleniumTest {
	...
	private final String IE_VN_IMG_PATH = "selenium_test_images/0013/Success/IE/vn/";
	private final String IE_JP_IMG_PATH = "selenium_test_images/0013/Success/IE/jp/";
	private final String IE_EN_IMG_PATH = "selenium_test_images/0013/Success/IE/en/";
	private final String FF_VN_IMG_PATH = "selenium_test_images/0013/Success/Firefox/vn/";
	private final String FF_JP_IMG_PATH = "selenium_test_images/0013/Success/Firefox/jp/";
	private final String FF_EN_IMG_PATH = "selenium_test_images/0013/Success/Firefox/en/";
	private final String CHR_VN_IMG_PATH = "selenium_test_images/0013/Success/Chrome/vn/";
	private final String CHR_JP_IMG_PATH = "selenium_test_images/0013/Success/Chrome/jp/";
	private final String CHR_EN_IMG_PATH = "selenium_test_images/0013/Success/Chrome/en/";
	...
	@Test
	public void test0013SearchProcessSelenium() throws Exception {
		String testMode = "";
		String imagePath = "";
		...
		for (int i = 0; i < testModeArray.length; i++) {
			...
			// Thread.sleep(1000);
			SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_BEFORE", "IVB_M_PROCESS");
			...
			// store log file name
			logFileNameArray.add(imagePath + "0013_1_1_1_1.log");
			// Thread.sleep(1000);
            driver.findElement(By.id("btnProcessScreen")).click();
            capture(imagePath + "0013_1_1_1_1");
            // Thread.sleep(1000);
            driver.findElement(By.id("txtProcessName")).clear();
            driver.findElement(By.id("txtProcessName")).sendKeys("o");
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
            ...
            // Thread.sleep(1000);
            driver.findElement(By.id("txtProcessName")).clear();
            driver.findElement(By.id("txtProcessName")).sendKeys("No_Data");
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
            ...
            // Thread.sleep(1000);
            driver.findElement(By.id("txtProcessName")).clear();
            driver.findElement(By.id("txtProcessName")).sendKeys("");
            // Thread.sleep(1000);
            driver.findElement(By.id("btnSearch")).click();
            // Thread.sleep(1000);
            
			SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_BEFORE_INSERT", "IVB_M_PROCESS");
			// Thread.sleep(1000);
            
            driver.findElement(By.id("btnRegister")).click();
            // Thread.sleep(1000);
            driver.findElement(By.id("txtProcessNamePopup")).clear();
            capture(imagePath + "0013_11_1_1_1");
            driver.findElement(By.id("txtProcessNamePopup")).sendKeys("");
            // Thread.sleep(1000);
            driver.findElement(By.id("btnRegisterPopup")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0013_11_3_2_1");
            // Thread.sleep(1000);
            driver.findElement(By.id("popup_ok")).click();
            // Thread.sleep(1000);
            ...
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0013_11_3_1_1.log");
			// Thread.sleep(1000);
            driver.findElement(By.id("btnRegisterPopup")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0013_11_3_1_1");
            // Thread.sleep(1000);
            driver.findElement(By.id("popup_ok")).click();
            // Thread.sleep(1000);
            
            SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_AFTER_INSERT", "IVB_M_PROCESS");
			
            // Thread.sleep(1000);
            
            SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_BEFORE_UPDATE", "IVB_M_PROCESS");
            // Thread.sleep(3000);
            ...
            driver.findElement(By.id("popup_ok")).click();
            // Thread.sleep(1000);
            SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_AFTER_UPDATE", "IVB_M_PROCESS");
			
            // Thread.sleep(2000);
			
			SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_BEFORE_DELETE", "IVB_M_PROCESS");
			// Thread.sleep(1000);
            ...
            SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_AFTER_DELETE", "IVB_M_PROCESS");
			
            // Thread.sleep(1000);
            driver.findElement(By.id("txtGoToPage")).clear();
            driver.findElement(By.id("txtGoToPage")).sendKeys("2");
            // Thread.sleep(1000);
            capture(imagePath + "0013_9_1_1_1");
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0013_7_1_1_1");
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0013_6_1_1_1");
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0013_8_1_1_1");
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0013_5_1_1_1");
            
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0013_12_1_1_1.log");
			// Thread.sleep(1000);
            
            driver.findElement(By.id("btnBack")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0013_12_1_1_1");
            // Thread.sleep(1000);
		}
	}
