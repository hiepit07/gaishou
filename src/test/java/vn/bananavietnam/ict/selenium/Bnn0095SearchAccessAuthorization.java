...
public class Bnn0095SearchAccessAuthorization {
	...
	public String fName;
	public String imagePath = "selenium_test_images/0095/Success/";
	@Parameter(1)
	public String fPass;
	...
	public void common(String browser, String language) {
		...
		try {
		    ...
		    if (language == "jp") {
		    	...
		    	// Thread.sleep(500);
		    	new Select(driver.findElement(By.id("cbbScreenDisplayEnableFlag"))).selectByVisibleText("有効");
		    	driver.findElement(By.id("cbbAddableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbAddableFlag"))).selectByVisibleText("有効");
			    driver.findElement(By.id("cbbUpdatableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbUpdatableFlag"))).selectByVisibleText("有効");
			    driver.findElement(By.id("cbbDeleteableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbDeleteableFlag"))).selectByVisibleText("有効");
			    driver.findElement(By.id("cbbReferenceableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbReferenceableFlag"))).selectByVisibleText("有効");
		    } else if (language == "en") {
		    	driver.findElement(By.id("cbbScreenDisplayEnableFlag")).click();
		    	// Thread.sleep(500);
		    	new Select(driver.findElement(By.id("cbbScreenDisplayEnableFlag"))).selectByVisibleText("Enabled");
		    	driver.findElement(By.id("cbbAddableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbAddableFlag"))).selectByVisibleText("Enabled");
			    driver.findElement(By.id("cbbUpdatableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbUpdatableFlag"))).selectByVisibleText("Enabled");
			    driver.findElement(By.id("cbbDeleteableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbDeleteableFlag"))).selectByVisibleText("Enabled");
			    driver.findElement(By.id("cbbReferenceableFlag")).click();
			    // Thread.sleep(500);
			    new Select(driver.findElement(By.id("cbbReferenceableFlag"))).selectByVisibleText("Enabled");
		    } else if (language == "vi") {
		    	// Thread.sleep(2000);
		    	new Select(driver.findElement(By.id("cbbScreenDisplayEnableFlag"))).selectByVisibleText("Hữu hiệu");
			    // Thread.sleep(2000);
			    new Select(driver.findElement(By.id("cbbAddableFlag"))).selectByVisibleText("Hữu hiệu");
			    // Thread.sleep(2000);
			    new Select(driver.findElement(By.id("cbbUpdatableFlag"))).selectByVisibleText("Hữu hiệu");
			    // Thread.sleep(2000);
			    new Select(driver.findElement(By.id("cbbDeleteableFlag"))).selectByVisibleText("Hữu hiệu");
			    // Thread.sleep(2000);
			    new Select(driver.findElement(By.id("cbbReferenceableFlag"))).selectByVisibleText("Hữu hiệu");
		    }
