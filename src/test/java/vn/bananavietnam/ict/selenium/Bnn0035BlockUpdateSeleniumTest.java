...
public class Bnn0035BlockUpdateSeleniumTest {
	...
	private final String IE_VN_IMG_PATH = "selenium_test_images/0035/Success/IE/vn/";
	private final String IE_JP_IMG_PATH = "selenium_test_images/0035/Success/IE/jp/";
	private final String IE_EN_IMG_PATH = "selenium_test_images/0035/Success/IE/en/";
	private final String FF_VN_IMG_PATH = "selenium_test_images/0035/Success/Firefox/vn/";
	private final String FF_JP_IMG_PATH = "selenium_test_images/0035/Success/Firefox/jp/";
	private final String FF_EN_IMG_PATH = "selenium_test_images/0035/Success/Firefox/en/";
	private final String CHR_VN_IMG_PATH = "selenium_test_images/0035/Success/Chrome/vn/";
	private final String CHR_JP_IMG_PATH = "selenium_test_images/0035/Success/Chrome/jp/";
	private final String CHR_EN_IMG_PATH = "selenium_test_images/0035/Success/Chrome/en/";
	private final String EDGE_VN_IMG_PATH = "selenium_test_images/0035/Success/Edge/vn/";
	private final String EDGE_JP_IMG_PATH = "selenium_test_images/0035/Success/Edge/jp/";
	private final String EDGE_EN_IMG_PATH = "selenium_test_images/0035/Success/Edge/en/";
	...
	@Test
	public void testBnn0035BlockUpdateSelenium() throws Exception {
		String testMode = "";
		String imagePath = "";
		...
		for (int i = 0; i < testModeArray.length; i++) {
			...
			// store log file name
			logFileNameArray.add(imagePath + "0035_1_1.log");
			driver.findElement(By.id("A001")).click();
			// Thread.sleep(3000);

			// take picture of Bnn0035 initialization state
			capture(imagePath + "0035_1_1");
			// Thread.sleep(3000);

			// select then deselect all checkbox
			// store check point information
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0035_2_1.log");
			driver.findElement(By.id("btnDeselectAll")).click();
			driver.findElement(By.id("btnSelectAll")).click();

			// take picture of Bnn0035 select all state
			capture(imagePath + "0035_2_1");
			// Thread.sleep(3000);

			driver.findElement(By.id("btnDeselectAll")).click();
			// select then deselect one checkbox at a time
			driver.findElement(By.name("B001")).click();
			driver.findElement(By.name("B002")).click();
			driver.findElement(By.name("B001")).click();
			driver.findElement(By.name("B002")).click();
			...
			// Thread.sleep(3000);
			// go back to Bnn0049 from Bnn0035
			driver.findElement(By.id("btnBack")).click();
			// Thread.sleep(3000);
			// select first farm to go to Bnn0035 again
			driver.findElement(By.id("A001")).click();
			// Thread.sleep(3000);
			// check on B002 block
			driver.findElement(By.id("btnDeselectAll")).click();
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0035_6_1.log");
			driver.findElement(By.name("0")).click();
			// Thread.sleep(3000);

			// take picture of Bnn0035 View details popup
			capture(imagePath + "0035_6_1");
			// Thread.sleep(3000);
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0035_7_1.log");
			driver.findElement(By.xpath("(//img[@name='0'])[2]")).click();
			// Thread.sleep(3000);

			// take picture of Bnn0035 Delete details popup
			capture(imagePath + "0035_7_1");
			// Thread.sleep(3000);
			driver.findElement(By.id("btnCancelPopup")).click();
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0035_8_1.log");
			driver.findElement(By.id("btnRegister")).click();
			// Thread.sleep(3000);

			// take picture of Bnn0035 Register details popup
			capture(imagePath + "0035_8_1");
			// Thread.sleep(3000);
			...
			// Thread.sleep(3000);
			new Select(driver.findElement(By.id("cbbTaskPopup"))).selectByIndex(3);
			// Thread.sleep(3000);
			...
			// take picture of Bnn0035 before inserting
			capture(imagePath + "0035_12_1_1_0.1");
			// Thread.sleep(3000);
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0035_12_1_1.log");
			driver.findElement(By.id("btnRegisterPopup")).click();
			// Thread.sleep(3000);

			// take picture of Bnn0035 insert successfully
			capture(imagePath + "0035_12_1_1_0.2");
			// dump data to file
			...
			// take picture of Bnn0035 before deleting
			capture(imagePath + "0035_12_2_1");
			// Thread.sleep(3000);

			// store check point information
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0035_12_2_2.log");
			driver.findElement(By.id("popup_ok")).click();
			// Thread.sleep(3000);

			// take picture of Bnn0035 delete successfully
			capture(imagePath + "0035_12_2_2");
			// dump data to file
