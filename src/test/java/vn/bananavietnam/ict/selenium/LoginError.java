...
public class LoginError {
	...
	private final String IE_VN_IMG_PATH = "selenium_test_images/0000/Error/IE/vn/";
	private final String IE_JP_IMG_PATH = "selenium_test_images/0000/Error/IE/jp/";
	private final String IE_EN_IMG_PATH = "selenium_test_images/0000/Error/IE/en/";
	private final String FF_VN_IMG_PATH = "selenium_test_images/0000/Error/Firefox/vn/";
	private final String FF_JP_IMG_PATH = "selenium_test_images/0000/Error/Firefox/jp/";
	private final String FF_EN_IMG_PATH = "selenium_test_images/0000/Error/Firefox/en/";
	private final String CHR_VN_IMG_PATH = "selenium_test_images/0000/Error/Chrome/vn/";
	private final String CHR_JP_IMG_PATH = "selenium_test_images/0000/Error/Chrome/jp/";
	private final String CHR_EN_IMG_PATH = "selenium_test_images/0000/Error/Chrome/en/";
	private final String EDGE_VN_IMG_PATH = "selenium_test_images/0000/Error/Edge/vn/";
	private final String EDGE_JP_IMG_PATH = "selenium_test_images/0000/Error/Edge/jp/";
	private final String EDGE_EN_IMG_PATH = "selenium_test_images/0000/Error/Edge/en/";
	...
	public void testLoginSeleniumError() throws Exception {
		...
		for (int i = 0; i < testModeArray.length; i++) {
			...
			// login
			// start testing
			// input user name or password wrong
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
 			// store log file name
 			logFileNameArray.add(imagePath + "0000_2_1_1_1.log");
			driver.switchTo().frame(driver.findElement(By.id("wrapperFrame")));
		    driver.findElement(By.id("j_username")).clear();
		    driver.findElement(By.id("j_username")).sendKeys("U0000000011");
		    driver.findElement(By.id("j_password")).clear();
		    driver.findElement(By.id("j_password")).sendKeys("U0000000001");
		    driver.findElement(By.id("btnLogin")).click();
		    capture(imagePath + "0000_2_1_1_1");
		    driver.findElement(By.id("popup_ok")).click();
		    checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
 			// store log file name
 			logFileNameArray.add(imagePath + "0000_2_1_1_2.log");
		    driver.findElement(By.id("j_username")).clear();
		    driver.findElement(By.id("j_password")).clear();
		    
		    // input user name and password blank
		    driver.findElement(By.id("j_username")).sendKeys("");
		    driver.findElement(By.id("j_password")).sendKeys("");
		    driver.findElement(By.id("btnLogin")).click();
		    capture(imagePath + "0000_2_1_1_2");
		    driver.findElement(By.id("popup_ok")).click();
		    
		    // Error connections internet
		    checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
 			// store log file name
 			logFileNameArray.add(imagePath + "0000_2_1_2_1.log");
		    SeleniumCommon.disableClientConnection();
		    driver.findElement(By.id("j_username")).sendKeys("U0000000001");
		    driver.findElement(By.id("j_password")).sendKeys("U0000000001");
		    driver.findElement(By.id("btnLogin")).click();
		    capture(imagePath + "0000_2_1_2_1");
		    driver.findElement(By.id("popup_ok")).click();
		    SeleniumCommon.enableClientConnection();
		    
		    // Error connections DB
		    checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
 			// store log file name
 			logFileNameArray.add(imagePath + "0000_2_1_3_1.log");
		    driver.findElement(By.id("j_username")).sendKeys("");
		    driver.findElement(By.id("j_username")).sendKeys("U0000000001");
		    driver.findElement(By.id("j_password")).sendKeys("");
		    driver.findElement(By.id("j_password")).sendKeys("U0000000001");
		    ...
		    driver.findElement(By.id("btnLogin")).click();
		    capture(imagePath + "0000_2_1_3_1");
		    driver.findElement(By.id("popup_ok")).click();
		    driver.findElement(By.id("j_username")).sendKeys("");
		    driver.findElement(By.id("j_username")).sendKeys("U1111111111");
		    driver.findElement(By.id("j_password")).sendKeys("");
		    driver.findElement(By.id("j_password")).sendKeys("U1111111111");
		    driver.findElement(By.id("j_username")).sendKeys("");
		    driver.findElement(By.id("j_username")).sendKeys("U2222222222");
		    driver.findElement(By.id("j_password")).sendKeys("");
		    driver.findElement(By.id("j_password")).sendKeys("U2222222222");
		    driver.findElement(By.id("j_username")).sendKeys("");
		    driver.findElement(By.id("j_username")).sendKeys("U3333333333");
		    driver.findElement(By.id("j_password")).sendKeys("");
		    driver.findElement(By.id("j_password")).sendKeys("U3333333333");
		    SeleniumCommon.enableDBServerConnection("BANANA_DB_HUNG_SELENIUM", "Hung");
