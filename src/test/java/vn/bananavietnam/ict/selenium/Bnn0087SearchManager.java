...
public class Bnn0087SearchManager {
	...
	private final String IE_VN_IMG_PATH = "selenium_test_images/0087/Success/IE/vn/";
	private final String IE_JP_IMG_PATH = "selenium_test_images/0087/Success/IE/jp/";
	private final String IE_EN_IMG_PATH = "selenium_test_images/0087/Success/IE/en/";
	private final String FF_VN_IMG_PATH = "selenium_test_images/0087/Success/Firefox/vn/";
	private final String FF_JP_IMG_PATH = "selenium_test_images/0087/Success/Firefox/jp/";
	private final String FF_EN_IMG_PATH = "selenium_test_images/0087/Success/Firefox/en/";
	private final String CHR_VN_IMG_PATH = "selenium_test_images/0087/Success/Chrome/vn/";
	private final String CHR_JP_IMG_PATH = "selenium_test_images/0087/Success/Chrome/jp/";
	private final String CHR_EN_IMG_PATH = "selenium_test_images/0087/Success/Chrome/en/";
	...
	@Test
	public void test0087SearchManagerSelenium() throws Exception {
		String testMode = "";
		String imagePath = "";
		...
		for (int i = 0; i < testModeArray.length; i++) {
			...
			// Thread.sleep(1000);
			SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_BEFORE", "IVB_M_MANAGER");
			...
			// store log file name
			logFileNameArray.add(imagePath + "0087_1_1_1_1.log");
			// Thread.sleep(1000);
            driver.findElement(By.id("btnManageScreen")).click();
            capture(imagePath + "0087_1_1_1_1");
            // Thread.sleep(1000);
            driver.findElement(By.id("txtUsersName")).clear();
            driver.findElement(By.id("txtUsersName")).sendKeys("U0000000003");
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
            ...
            // Thread.sleep(1000);
            driver.findElement(By.id("txtUsersName")).clear();
            driver.findElement(By.id("txtUsersName")).sendKeys("No_Data");
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0087_3_1_2_1.log");
			// Thread.sleep(1000);
            driver.findElement(By.id("btnSearch")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0087_3_1_2_1");
            // Thread.sleep(1000);
            ...
            SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_BEFORE_UPDATE", "IVB_M_MANAGER");
            // Thread.sleep(3000);
            ...
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0087_4_3_1_1.log");
			// Thread.sleep(1000);
            driver.findElement(By.id("btn-submit")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0087_4_3_1_1");
            // Thread.sleep(1000);
            driver.findElement(By.id("popup_ok")).click();
            // Thread.sleep(1000);
            SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_AFTER_UPDATE", "IVB_M_MANAGER");
			
            // Thread.sleep(2000);
			
			SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_BEFORE_DELETE", "IVB_M_MANAGER");
			// Thread.sleep(1000);
			
            driver.findElement(By.xpath("(//img[@name='2'])[2]")).click();
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
            ...
            driver.findElement(By.id("popup_ok")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0087_5_1_1_1");
            // Thread.sleep(3000);
            
            SeleniumCommon.dumpDataToFile("BANANA_DB_HUNG_SELENIUM", "E:/" + imagePath + "DATA_AFTER_DELETE", "IVB_M_MANAGER");
			
            // Thread.sleep(1000);
            driver.findElement(By.id("txtGoToPage")).clear();
            driver.findElement(By.id("txtGoToPage")).sendKeys("2");
            // Thread.sleep(1000);
            capture(imagePath + "0087_10_1_1_1");
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0087_10_1_1_1.log");
			// Thread.sleep(1000);
            driver.findElement(By.id("btnGoToPage")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0087_11_1_1_1");
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0087_8_1_1_1");
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0087_7_1_1_1");
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0087_9_1_1_1");
            ...
            // Thread.sleep(1000);
            capture(imagePath + "0087_6_1_1_1");
            
            // Thread.sleep(3000);
            checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0087_13_1_1_1.log");
			// Thread.sleep(1000);
            
            driver.findElement(By.id("btnBack")).click();
            // Thread.sleep(1000);
            capture(imagePath + "0087_13_1_1_1");
            // Thread.sleep(1000);
		}
	}
