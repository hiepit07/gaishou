...
public class Bnn0037BlockDetailUpdateSeleniumErrorTest {
	...
	private final String IE_VN_IMG_PATH = "selenium_test_images/0037/Error/IE/vn/";
	private final String IE_JP_IMG_PATH = "selenium_test_images/0037/Error/IE/jp/";
	private final String IE_EN_IMG_PATH = "selenium_test_images/0037/Error/IE/en/";
	private final String FF_VN_IMG_PATH = "selenium_test_images/0037/Error/Firefox/vn/";
	private final String FF_JP_IMG_PATH = "selenium_test_images/0037/Error/Firefox/jp/";
	private final String FF_EN_IMG_PATH = "selenium_test_images/0037/Error/Firefox/en/";
	private final String CHR_VN_IMG_PATH = "selenium_test_images/0037/Error/Chrome/vn/";
	private final String CHR_JP_IMG_PATH = "selenium_test_images/0037/Error/Chrome/jp/";
	private final String CHR_EN_IMG_PATH = "selenium_test_images/0037/Error/Chrome/en/";
	private final String EDGE_VN_IMG_PATH = "selenium_test_images/0037/Error/Edge/vn/";
	private final String EDGE_JP_IMG_PATH = "selenium_test_images/0037/Error/Edge/jp/";
	private final String EDGE_EN_IMG_PATH = "selenium_test_images/0037/Error/Edge/en/";
	...
	@Test
	public void testBnn0037BlockDetailUpdateSeleniumError() throws Exception {
		String testMode = "";
		String imagePath = "";
		String pageLanguage = "";
		...
		for (int i = 0; i < testModeArray.length; i++) {
			...
			// take picture of Bnn0037 initialization state with no area error
			capture(imagePath + "0037_2_1_1_1");
			// insert all area ----------------------------
			...
			driver.findElement(By.id("btnLogin")).click();
			// select 044 block
			driver.findElement(By.linkText("B044")).click();
			// take picture of Bnn0037 initialization state with no product error
			capture(imagePath + "0037_2_1_2_1");
			...
			// select first block
			driver.findElement(By.linkText("B000")).click();
			// take picture of Bnn0037 initialization state with client connection error
			capture(imagePath + "0037_2_1_4_1");
			...
			// store log file name
			logFileNameArray.add(imagePath + "0037_2_1_5_1.log");
			driver.findElement(By.linkText("B000")).click();
			// take picture of Bnn0037 initialization state with server connection error
			capture(imagePath + "0037_2_1_5_1");
			...
			capture(imagePath + "0037_3_1_1_1");
			...
			capture(imagePath + "0037_3_1_3_1");
			driver.findElement(By.id("popup_ok")).click();
			// start client connection ----------------------------
			SeleniumCommon.enableClientConnection();
			// stop server connection ----------------------------
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_3_1_4_1.log");
			driver.findElement(By.name("0")).click();
			// take picture of opening View details popup with server connection error
			capture(imagePath + "0037_3_1_4_1");
			driver.findElement(By.id("popup_ok")).click();
			// start server connection ----------------------------
			SeleniumCommon.enableDBServerConnection("BANANA_DB_KHOA", "Khoa");
			...
			capture(imagePath + "0037_4_1_1_1");
			driver.findElement(By.id("popup_ok")).click();
			// stop client connection ----------------------------
			SeleniumCommon.disableClientConnection();
			// open Delete details popup
			...
			capture(imagePath + "0037_4_1_3_1");
			driver.findElement(By.id("popup_ok")).click();
			// start client connection ----------------------------
			SeleniumCommon.enableClientConnection();
			// stop server connection ----------------------------
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_4_1_4_1.log");
			driver.findElement(By.xpath("(//img[@name='0'])[2]")).click();
			// take picture of opening Delete details popup with server connection error
			capture(imagePath + "0037_4_1_4_1");
			driver.findElement(By.id("popup_ok")).click();
			// start server connection ----------------------------
			SeleniumCommon.enableDBServerConnection("BANANA_DB_KHOA", "Khoa");
			...
			capture(imagePath + "0037_5_1_1_1_");
			driver.findElement(By.id("popup_ok")).click();
			// stop client connection ----------------------------
			SeleniumCommon.disableClientConnection();
			// open Register details popup
			...
			capture(imagePath + "0037_5_1_3_1");
			driver.findElement(By.id("popup_ok")).click();
			// start client connection ----------------------------
			SeleniumCommon.enableClientConnection();
			// stop server connection ----------------------------
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_5_1_4_1.log");
			driver.findElement(By.id("btnRegister")).click();
			// take picture of opening Register details popup with server connection error
			capture(imagePath + "0037_5_1_4_1");
			driver.findElement(By.id("popup_ok")).click();
			// start server connection ----------------------------
			SeleniumCommon.enableDBServerConnection("BANANA_DB_KHOA", "Khoa");
			// insert all process ----------------------------
			...
			capture(imagePath + "0037_6_1_2_1");
			driver.findElement(By.id("popup_ok")).click();
			// start client connection ----------------------------
			SeleniumCommon.enableClientConnection();
			// stop server connection ----------------------------
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_6_1_3_1.log");
			...
			capture(imagePath + "0037_6_1_3_1");
			driver.findElement(By.id("popup_ok")).click();
			...
			capture(imagePath + "0037_7_1_3_1");
			driver.findElement(By.id("popup_ok")).click();
			// start client connection ----------------------------
			SeleniumCommon.enableClientConnection();
			// stop server connection ----------------------------
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_7_1_1_1.log");
			// store check point information
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_7_1_4_1.log");
			// start delete
			driver.findElement(By.id("btnRegisterPopup")).click();
			driver.findElement(By.id("popup_ok")).click();
			Thread.sleep(5000);
			// take picture of deleting with server connection error
			capture(imagePath + "0037_7_1_1_1");
			capture(imagePath + "0037_7_1_4_1");
			driver.findElement(By.id("popup_ok")).click();
			driver.findElement(By.id("btnCancelPopup")).click();
			// start server connection ----------------------------
			SeleniumCommon.enableDBServerConnection("BANANA_DB_KHOA", "Khoa");
			...
			capture(imagePath + "0037_8_1_3_1");
			driver.findElement(By.id("popup_ok")).click();
			// start client connection ----------------------------
			SeleniumCommon.enableClientConnection();
			// stop server connection ----------------------------
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_8_1_1_1.log");
			// store check point information
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			// store log file name
			logFileNameArray.add(imagePath + "0037_8_1_4_1.log");
			// start insert
			driver.findElement(By.id("btnRegisterPopup")).click();
			Thread.sleep(5000);
			// take picture of inserting with server connection error
			capture(imagePath + "0037_8_1_1_1");
			capture(imagePath + "0037_8_1_4_1");
			driver.findElement(By.id("popup_ok")).click();
			driver.findElement(By.id("btnCancelPopup")).click();
			// start server connection ----------------------------
			SeleniumCommon.enableDBServerConnection("BANANA_DB_KHOA", "Khoa");
