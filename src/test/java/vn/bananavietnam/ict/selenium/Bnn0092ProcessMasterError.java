...
public class Bnn0092ProcessMasterError {
	...
	private final String IE_VN_IMG_PATH = "selenium_test_images/0092/Error/IE/vn/";
	private final String IE_JP_IMG_PATH = "selenium_test_images/0092/Error/IE/jp/";
	private final String IE_EN_IMG_PATH = "selenium_test_images/0092/Error/IE/en/";
	private final String FF_VN_IMG_PATH = "selenium_test_images/0092/Error/Firefox/vn/";
	private final String FF_JP_IMG_PATH = "selenium_test_images/0092/Error/Firefox/jp/";
	private final String FF_EN_IMG_PATH = "selenium_test_images/0092/Error/Firefox/en/";
	private final String CHR_VN_IMG_PATH = "selenium_test_images/0092/Error/Chrome/vn/";
	private final String CHR_JP_IMG_PATH = "selenium_test_images/0092/Error/Chrome/jp/";
	private final String CHR_EN_IMG_PATH = "selenium_test_images/0092/Error/Chrome/en/";
	private final String EDGE_VN_IMG_PATH = "selenium_test_images/0092/Error/Edge/vn/";
	private final String EDGE_JP_IMG_PATH = "selenium_test_images/0092/Error/Edge/jp/";
	private final String EDGE_EN_IMG_PATH = "selenium_test_images/0092/Error/Edge/en/";
	...
	public void setUp() throws Exception {
		...
		// set test URL
		baseUrl = "http://172.16.0.131:8080";
	}

	@Test
	public void testBnn0092ProcessMasterSelenium() throws Exception {
		String testMode = "";
		String imagePath = "";
		...
		for (int i = 0; i < testModeArray.length; i++) {
			...
			driver.findElement(By.cssSelector(".tbl-process-un .acRow:first-child"));
			SeleniumCommon.sessionTimeOut();
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_2_1_1_1.log");
			driver.findElement(By.cssSelector(".tbl-process-un .acRow:first-child")).click();
			capture(imagePath + "/0092_2_1_1_1");
			driver.get(baseUrl + "/ict/");
			driver.switchTo().frame(driver.findElement(By.id("wrapperFrame")));
			...
			driver.findElement(By.cssSelector(".tbl-process-re .acRow:first-child"));
			SeleniumCommon.sessionTimeOut();
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_3_1_1_1.log");
			driver.findElement(By.cssSelector(".tbl-process-re .acRow:first-child")).click();
			...
			SeleniumCommon.sessionTimeOut();
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_4_1_1_1.log");
			driver.findElement(By.cssSelector("#btnRegister")).click();
			capture(imagePath + "/0092_4_1_1_1");
			driver.get(baseUrl + "/ict/");
			driver.switchTo().frame(driver.findElement(By.id("wrapperFrame")));
			...
			SeleniumCommon.sessionTimeOut();
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_5_1_1_1.log");
			driver.findElement(By.cssSelector("#btnBack")).click();
			capture(imagePath + "/0092_5_1_1_1");
			driver.get(baseUrl + "/ict/");
			driver.switchTo().frame(driver.findElement(By.id("wrapperFrame")));
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_2_2_1_1.log");
			driver.findElement(By.cssSelector(".tbl-process-un .acRow:first-child")).click();
			driver.findElement(By.id("popup_ok"));
			capture(imagePath + "/0092_2_2_1_1");
			driver.findElement(By.id("popup_ok")).click();

			driver.findElement(By.cssSelector("#btn_get")).click();
			driver.findElement(By.cssSelector(".tbl-process-re .acRow:first-child"));
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_3_2_1_1.log");
			driver.findElement(By.cssSelector(".tbl-process-re .acRow:first-child")).click();
			driver.findElement(By.id("popup_ok"));
			capture(imagePath + "/0092_3_2_1_1");
			driver.findElement(By.id("popup_ok")).click();

			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_4_2_1_1.log");
			driver.findElement(By.cssSelector("#btnRegister")).click();
			driver.findElement(By.id("popup_ok"));
			capture(imagePath + "/0092_4_2_1_1");
			driver.findElement(By.id("popup_ok")).click();

			driver.findElement(By.cssSelector("#btn_back")).click();
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_4_3_1_1.log");
			driver.findElement(By.cssSelector("#btnBack")).click();
			driver.findElement(By.id("popup_ok"));
			capture(imagePath + "/0092_4_3_1_1");
			driver.findElement(By.id("popup_ok")).click();
			...
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_2_3_1_1.log");
			driver.findElement(By.cssSelector(".tbl-process-un .acRow:first-child")).click();
			driver.findElement(By.id("popup_ok"));
			capture(imagePath + "/0092_2_3_1_1");
			driver.findElement(By.id("popup_ok")).click();

			driver.findElement(By.cssSelector("#btn_get")).click();
			driver.findElement(By.cssSelector(".tbl-process-re .acRow:first-child"));
			checkPointArray.add(SeleniumCommon.createCurrentCheckPoint());
			logFileNameArray.add(imagePath + "/0092_3_3_1_1.log");
			driver.findElement(By.cssSelector(".tbl-process-re .acRow:first-child")).click();
			driver.findElement(By.id("popup_ok"));
			capture(imagePath + "/0092_3_3_1_1");
			driver.findElement(By.id("popup_ok")).click();
